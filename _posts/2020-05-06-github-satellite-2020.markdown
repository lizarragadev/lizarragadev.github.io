...
Si en tu día a día utilizas **[GitHub](https://github.com/){:target="_blank"}** como sistema para almacenar tus proyectos de Software, seguramente te interesará saber las novedades que GitHub nos presentó en su evento anual.
...
**[GitHub Satellite Virtual 2020](https://githubsatellite.com/){:target="_blank"}**, se llevó a cabo éste 6 de Mayo mediante transmisión por [YouTube](https://www.youtube.com/watch?v=FhZTPM9ysWk){:target="_blank"}. Algunos de los tópicos tocados en el evento fueron: Novedades de GitHub, vulneravilidades de software, GitHub Actions, Javascript, NPM, AWS y muchos otros temas de tecnología en general.

## Novedades

**Nat Friedman** CEO de GitHub inició el evento con un Keynote resumiento lo más relevante que se presentará en el evento. 

![Octocat](https://lizarraga.dev/images/posts/GitHubSatellite/welcometocat.png =250x)
...
Si quieres ver como funcionan las **GitHub Discussions** puedes ingresar a ver las [Discussions de GitHub Satellite Virtual 2020](https://github.com/githubevents/satellite2020/discussions?utm_source=announcement&utm_medium=blog&utm_campaign=satellite-product-recap){:target="_blank"}.
...
Puedes solicitar acceder al acceso temprano de **[Codespaces.](https://github.com/features/codespaces/?utm_source=announcement&utm_medium=blog&utm_campaign=satellite-product-recap){:target="_blank"}**
...
* **Code Scanning**:
    ...
    El escaneo de código se lo realiza mediante **[CodeQL](https://securitylab.github.com/tools/codeql){:target="_blank"}** que es el motor semántico más avanzado del mundo.
...
Y si quieres ver toda la transmisión del evento puede verlo en **[Youtube](https://www.youtube.com/watch?v=FhZTPM9ysWk){:target="_blank"}.**
