...
Éste año 2020, el evento debía llevarse a cabo en Paris - Francia. Pero para resguardar la seguridad de los participantes por el tema del COVID-19, se llevó a cabo de forma virtual para no perdernos las últimas novedades que nos presenta.
...
* GitHub Code Scanning. Escaneo de tu código para mantener o proveer código seguro.
...
Si bien alguno dirá que ya existían "Discussions" en GitHub pero ésta de encuentra enlazado a una base de código. En éste caso GitHub Discussion pretende ser una alternativa para poder generar conocimiento y solución de preguntas dentro de un repositorio, las cuáles pueden ser marcadas como respondidas.

![GitHub Discussions](https://lizarraga.dev/images/posts/GitHubSatellite/discussions.png)

Al diferencia de los ´issues´ que desaparecen cuando uno los culmina, las "Discussions" se mantienen visibles para que otros desarrolladores puedan aprender.

En otras palabras, una competencia a Stackoverflow 😂 (Sólo es broma).

Si quieres ver como funcionan las GitHub Discussion puedes ingresar a ver las [Discussion de GitHub Satellite Virtual 2020](https://github.com/githubevents/satellite2020/discussions?utm_source=announcement&utm_medium=blog&utm_campaign=satellite-product-recap).
...
Se encuentra de forma gratuita mientras esté en beta. Luego se presentarán los precios si quieren utilizar a GitHub como entorno de despliegue en la nube para realmente vivir esa experiencia de trabajar localmente pero en la nube.
...
![GitHub Discussions](https://lizarraga.dev/images/posts/GitHubSatellite/codescanning.png)
...
* Secret Scanning
    Anteriormente se lo conocia como "token scanning" que estaba disponible desde 2018. Que se encontraba disponible en repositorios públicos. Ahora también los repositorios privados podrán gozar de un escaneo del código para poder detectar vulnerabilidades potenciales y notificarlos mediante un pull-request.

Ambas características se están trabajando para que sean gratuitas a todos los usuarios. Puede solicitar que te den acceso temprano a [Code y Secret Scanning](https://github.com/features/security/advanced-security/signup?utm_source=announcement&utm_medium=blog&utm_campaign=satellite-product-recap)
